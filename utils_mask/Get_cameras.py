...
# #DINOv2
# backbone_model = torch.hub.load('facebookresearch/dinov2', 'dinov2_vits14_reg')
# backbone_model.eval()
# backbone_model.cuda()
...
if __name__ == "__main__":
    ...
    #     #TODO: save cameras
        ...
        for c in tqdm(cam_params, desc="Cameras rendering"):
            ...
            #TODO compute and save descriptors
        ...
        # output_path = os.path.join("./data/figurines_mask", o["id"], "descriptors")
        # os.makedirs(output_path, exist_ok=True)
        # torch.save(features, os.path.join(output_path, '{0:05d}'.format(i) + ".pt"))

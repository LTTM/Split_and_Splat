...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, pixel_index, color, radii, pixels, geomBuffer, binningBuffer, imgBuffer, invdepths = _C.rasterize_gaussians(*args)
        ...
        return color, radii, invdepths, pixels[:pixel_index]

...
class Camera(nn.Module):
    def __init__(self, resolution, colmap_id, R, T, FoVx, FoVy, depth_params, image, image_mask, invdepthmap,
                 image_name, uid,
        ...
        self.original_mask = gt_mask.clamp(0.0, 1.0).to(self.data_device)
